"""
Utility functions to handle conversion between v1 (string) and v2 (array) question formats.
This ensures backward compatibility while supporting the new v2 format.
"""
